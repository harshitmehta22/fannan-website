                                    ...
                                    <div className="row">
                                        <div className="col-md-6 col-lg-5 col-xl-4 mb-4 mb-md-0">
                                            ...
                                            <div className="p-3">
                                                ...
                                                <div data-mdb-perfect-scrollbar="true" className="right-block">
                                                    <ul className="list-unstyled mb-0">
                                                        ...
                                                        <li className="p-2 border-bottom">
                                                            <a href="#!" className="d-flex justify-content-between text-left">
                                        ...
                                        <div className="col-md-6 col-lg-7 col-xl-8">
                                            ...
                                            <div className="pt-3 pe-3" data-mdb-perfect-scrollbar="true" style={{ position: "relative", height: "400px", overflowY: "scroll" }}>
                                                <div className="d-flex flex-row justify-content-start text-left">
                                                ...
                                                <div className="d-flex flex-row justify-content-end text-right">
                                                    <div>
                                                        <p className="small p-2 me-3 mb-1 text-white rounded-3 bg-primary" style={{ backgroundColor: "#f5f6f7" }}>Ut enim ad minim veniam,
                                                            quis
                                                ...
                                                <div className="d-flex flex-row justify-content-end text-right">
                                                    <div>
                                                        <p className="small p-2 me-3 mb-1 text-white rounded-3 bg-primary" style={{ backgroundColor: "#f5f6f7" }}>Excepteur sint occaecat
                                                            cupidatat
                                                ...
                                                <div className="d-flex flex-row justify-content-end text-right">
                                                    <div>
                                                        <p className="small p-2 me-3 mb-1 text-white rounded-3 bg-primary" style={{ backgroundColor: "#f5f6f7" }}>Nemo enim ipsam
                                                            voluptatem quia
                                                ...
                                                <div className="d-flex flex-row justify-content-end text-right">
                                                    <div>
                                                        <p className="small p-2 me-3 mb-1 text-white rounded-3 bg-primary" style={{ backgroundColor: "#f5f6f7" }}>Ut enim ad minima veniam,
                                                            quis
